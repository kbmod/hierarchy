        ...
        def do_POST(self) -> None:  # noqa: N802
            ...
            try:
                ...
                if path == "/api/auth/oauth/start":
                    ...
                    pending = oauth.start_grok() if provider == "grok" else oauth.start_chatgpt() if provider == "chatgpt" else None
                    if pending is None:
                ...
                if path == "/api/bots":
                    ...
                    self._json(201, {"id": bot.id, "name": bot.name, "job": bot.job})
                    return
...
<style>
  ...
  button, input, textarea { font: inherit; color: inherit; background: #1c1c1c; border: 1px solid #444; border-radius: 6px; padding: 8px; }
